...
namespace Soenneker.Intercom.OpenApiClient.Conversations
{
    ...
    public partial class ConversationsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <returns>A <see cref="global::Soenneker.Intercom.OpenApiClient.Conversations.Item.ConversationItemRequestBuilder"/></returns>
        public global::Soenneker.Intercom.OpenApiClient.Conversations.Item.ConversationItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("conversation%2Did", position);
                return new global::Soenneker.Intercom.OpenApiClient.Conversations.Item.ConversationItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Intercom.OpenApiClient.Models.ConversationList"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Intercom.OpenApiClient.Models.ConversationList?> GetAsync(Action<RequestConfiguration<global::Soenneker.Intercom.OpenApiClient.Conversations.ConversationsRequestBuilder.ConversationsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Intercom.OpenApiClient.Models.ConversationList> GetAsync(Action<RequestConfiguration<global::Soenneker.Intercom.OpenApiClient.Conversations.ConversationsRequestBuilder.ConversationsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Intercom.OpenApiClient.Models.ConversationList>(requestInfo, global::Soenneker.Intercom.OpenApiClient.Models.ConversationList.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Intercom.OpenApiClient.Models.CreateConversation200Response"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Intercom.OpenApiClient.Models.CreateConversation200Response?> PostAsync(global::Soenneker.Intercom.OpenApiClient.Models.CreateConversationRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Intercom.OpenApiClient.Models.CreateConversation200Response> PostAsync(global::Soenneker.Intercom.OpenApiClient.Models.CreateConversationRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Intercom.OpenApiClient.Models.CreateConversation200Response>(requestInfo, global::Soenneker.Intercom.OpenApiClient.Models.CreateConversation200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// You can fetch a list of all conversations.You can optionally request the result page size and the cursor to start after to fetch the result.{% admonition type=&quot;warning&quot; name=&quot;Pagination&quot; %}  You can use pagination to limit the number of results returned. The default is `20` results per page.  See the [pagination section](https://developers.intercom.com/docs/build-an-integration/learn-more/rest-apis/pagination/#pagination-for-list-apis) for more details on how to use the `starting_after` param.{% /admonition %}
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Intercom.OpenApiClient.Models.CreateConversationRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Intercom.OpenApiClient.Models.CreateConversationRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)

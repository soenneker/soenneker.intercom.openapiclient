...
using Soenneker.Intercom.OpenApiClient.Conversations.Item.Customers.Item;
...
namespace Soenneker.Intercom.OpenApiClient.Conversations.Item.Customers
{
    ...
    public partial class CustomersRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Intercom.OpenApiClient.Conversations.Item.Customers.CustomersRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="body">Payload of the request to assign a conversation</param>
...
#nullable enable
        public async Task<global::Soenneker.Intercom.OpenApiClient.Models.Conversation?> PostAsync(global::Soenneker.Intercom.OpenApiClient.Models.AttachContactToConversationRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Intercom.OpenApiClient.Models.Conversation> PostAsync(global::Soenneker.Intercom.OpenApiClient.Models.AttachContactToConversationRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Intercom.OpenApiClient.Models.AttachContactToConversationRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Intercom.OpenApiClient.Models.AttachContactToConversationRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Intercom.OpenApiClient.Conversations.Item.Customers.CustomersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Intercom.OpenApiClient.Conversations.Item.Customers.CustomersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Intercom.OpenApiClient.Conversations.Item.Customers.CustomersRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}

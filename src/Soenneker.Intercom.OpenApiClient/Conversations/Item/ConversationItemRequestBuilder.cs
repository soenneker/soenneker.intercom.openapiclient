...
{
    /// <summary>
    /// Builds and executes requests for operations under \conversations\{conversation-id}
    /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<global::Soenneker.Intercom.OpenApiClient.Conversations.Item.ConversationItemRequestBuilder.ConversationItemRequestBuilderDeleteQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<global::Soenneker.Intercom.OpenApiClient.Conversations.Item.ConversationItemRequestBuilder.ConversationItemRequestBuilderDeleteQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Intercom.OpenApiClient.Conversations.Item.ConversationItemRequestBuilder.ConversationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Intercom.OpenApiClient.Conversations.Item.ConversationItemRequestBuilder.ConversationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Intercom.OpenApiClient.Conversations.Item.ConversationItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Intercom.OpenApiClient.Conversations.Item.ConversationItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// &quot;{% admonition type=\&quot;warning\&quot; name=\&quot;Irreversible operation\&quot; %}Deleting a conversation is permanent and cannot be reversed.{% /admonition %}You can delete a single conversation. The behavior depends on the `retain_metrics` parameter:- **With `retain_metrics=true` (default)**: Deletes the conversation while retaining reporting data. The conversation will still appear in reporting, though some data may be incomplete due to the deletion.- **With `retain_metrics=false`**: Deletes the conversation and all associated reporting data. The conversation will be completely removed from both the inbox and all reporting.{% admonition type=\&quot;info\&quot; name=\&quot;Required scope for retain_metrics=false\&quot; %}Using `retain_metrics=false` requires the `delete_conversations_and_metrics` OAuth scope.{% /admonition %}For more info, see [this help center article](https://www.intercom.com/help/en/articles/13885146-deleting-a-conversation).&quot;
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ConversationItemRequestBuilderDeleteQueryParameters 
        {
        ...
        {
            /// <summary>Set to plaintext to retrieve conversation messages in plain text. This affects both the body and subject fields. Inline links are rendered as `label (url)`, preserving the link URL alongside the visible text.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ConversationItemRequestBuilderPutQueryParameters 
        {
            /// <summary>Set to plaintext to retrieve conversation messages in plain text. This affects both the body and subject fields. Inline links are rendered as `label (url)`, preserving the link URL alongside the visible text.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable

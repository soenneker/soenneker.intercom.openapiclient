...
namespace Soenneker.Intercom.OpenApiClient.Models
{
    ...
    public partial class SearchActivityLogsRequest : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public List<string> EventTypes { get; set; }
#endif
        /// <summary>The page number of results to return.</summary>
        public int? Page { get; set; }
        /// <summary>The number of results per page. Must be between 1 and 250.</summary>
        public int? PerPage { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Intercom.OpenApiClient.Models.SearchActivityLogsRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Intercom.OpenApiClient.Models.SearchActivityLogsRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Intercom.OpenApiClient.Models.SearchActivityLogsRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Intercom.OpenApiClient.Models.SearchActivityLogsRequest();
        }
        /// <summary>

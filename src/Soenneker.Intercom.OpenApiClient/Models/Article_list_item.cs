...
namespace Soenneker.Intercom.OpenApiClient.Models
{
    ...
    public partial class Article_list_item : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public global::Soenneker.Intercom.OpenApiClient.Models.Article_list_item_state? State { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Intercom.OpenApiClient.Models.Article_translated_content? TranslatedContent { get; set; }
#nullable restore
#else
        public global::Soenneker.Intercom.OpenApiClient.Models.Article_translated_content TranslatedContent { get; set; }
#endif
        /// <summary>The type of object - `article`.</summary>
        public global::Soenneker.Intercom.OpenApiClient.Models.Article_list_item_type? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Intercom.OpenApiClient.Models.Article_list_item"/> and sets the default values.
        /// </summary>
        public Article_list_item()
        {
            AdditionalData = new Dictionary<string, object>();
            State = global::Soenneker.Intercom.OpenApiClient.Models.Article_list_item_state.Draft;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Intercom.OpenApiClient.Models.Article_list_item"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Intercom.OpenApiClient.Models.Article_list_item CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Intercom.OpenApiClient.Models.Article_list_item();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "state", n => { State = n.GetEnumValue<global::Soenneker.Intercom.OpenApiClient.Models.Article_list_item_state>(); } },
                ...
                { "translated_content", n => { TranslatedContent = n.GetObjectValue<global::Soenneker.Intercom.OpenApiClient.Models.Article_translated_content>(global::Soenneker.Intercom.OpenApiClient.Models.Article_translated_content.CreateFromDiscriminatorValue); } },
                { "type", n => { Type = n.GetEnumValue<global::Soenneker.Intercom.OpenApiClient.Models.Article_list_item_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Intercom.OpenApiClient.Models.Article_list_item_state>("state", State);
            writer.WriteObjectValue<global::Soenneker.Intercom.OpenApiClient.Models.Tags>("tags", Tags);
            writer.WriteStringValue("title", Title);
            writer.WriteObjectValue<global::Soenneker.Intercom.OpenApiClient.Models.Article_translated_content>("translated_content", TranslatedContent);
            writer.WriteEnumValue<global::Soenneker.Intercom.OpenApiClient.Models.Article_list_item_type>("type", Type);

...
namespace Soenneker.Intercom.OpenApiClient.Models
{
    ...
    public partial class CreateMessageRequestFrom : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public CreateMessageRequestFrom()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Intercom.OpenApiClient.Models.CreateMessageRequestFrom"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Intercom.OpenApiClient.Models.CreateMessageRequestFrom CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Intercom.OpenApiClient.Models.CreateMessageRequestFrom();
        }
        /// <summary>

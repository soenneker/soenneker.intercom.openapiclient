...
namespace Soenneker.Intercom.OpenApiClient.Models
{
    ...
    public partial class DeletedHelpCenterRedirectObject : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Whether the redirect was deleted successfully or not.</summary>
        public bool? Deleted { get; set; }
        /// <summary>The unique identifier for the redirect which you provided in the URL.</summary>
...
#nullable restore
        ...
        /// </summary>
        public DeletedHelpCenterRedirectObject()
        {
        ...
        public static global::Soenneker.Intercom.OpenApiClient.Models.DeletedHelpCenterRedirectObject CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Intercom.OpenApiClient.Models.DeletedHelpCenterRedirectObject();
        }
        /// <summary>

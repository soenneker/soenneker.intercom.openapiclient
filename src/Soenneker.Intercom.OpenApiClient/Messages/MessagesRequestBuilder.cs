...
using Soenneker.Intercom.OpenApiClient.Messages.Status;
using Soenneker.Intercom.OpenApiClient.Messages.Whatsapp;
...
using System;
namespace Soenneker.Intercom.OpenApiClient.Messages
{
    /// <summary>
    ...
    public partial class MessagesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Intercom.OpenApiClient.Messages.Status.StatusRequestBuilder Status
        {
            get => new global::Soenneker.Intercom.OpenApiClient.Messages.Status.StatusRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The whatsapp property</summary>
        public global::Soenneker.Intercom.OpenApiClient.Messages.Whatsapp.WhatsappRequestBuilder Whatsapp
        {
            get => new global::Soenneker.Intercom.OpenApiClient.Messages.Whatsapp.WhatsappRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Intercom.OpenApiClient.Messages.MessagesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="body">You can create a message</param>
...
#nullable enable
        public async Task<global::Soenneker.Intercom.OpenApiClient.Models.Message?> PostAsync(global::Soenneker.Intercom.OpenApiClient.Models.Create_message_request body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Intercom.OpenApiClient.Models.Message> PostAsync(global::Soenneker.Intercom.OpenApiClient.Models.Create_message_request body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Intercom.OpenApiClient.Models.Create_message_request body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Intercom.OpenApiClient.Models.Create_message_request body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Intercom.OpenApiClient.Messages.MessagesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Intercom.OpenApiClient.Messages.MessagesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Intercom.OpenApiClient.Messages.MessagesRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
